...
trainIds =  getDirId("/Users/lmy/Downloads/data/train")
testIds =  getDirId("/Users/lmy/Downloads/data/test")
...
for id in ids:
    ...
    if len(annos["imgs"][id]["objects"]) > 0 and (id in trainIds):
        ...
        edit_xml(objects, id, dir = "/Users/lmy/Downloads/data/xmlLabel/train")
        
    elif len(annos["imgs"][id]["objects"]) > 0 and (id in testIds):
        objects = annos["imgs"][id]["objects"]
        edit_xml(objects, id, dir = "/Users/lmy/Downloads/data/xmlLabel/test")